...
from Schema.quotation import ParameterInfo
...
class QuotationGenerator:
    ...
    def __init__(self, template_dir='utility/quotation_pdf_generator/template'):
    ...
    def get_default_data(self):
        ...
        return {
            ...
            'logo_path': 'static/quotation_pdf_logo_and_pic/logo.png',
            'stamp_image':'static/quotation_pdf_logo_and_pic/img.png',
            'show_watermark': True,
...
def quotation_pdf_create(c_id, parameter_info: List[ParameterInfo]):
    ...
    custom_file = generator.generate_pdf(custom_data, "outputfile.pdf")
...
# main(2,[{
#             "parameter_id": 6,
#             "name": "Sampling of Poly Aromatic Hydrocarbons (PAHs)",
#             "cost": 440,
#             "quantity": 1
#         }])
